...
FULL_CONFORMANCE_PRECEDENCE = ("FAIL", "UNKNOWN", "UNSUPPORTED", "PASS", "NOT_APPLICABLE")
    ...
    return {
        "aggregation_precedence": {
            ...
            "full_conformance": {
                ...
                "rule": "FAIL>UNKNOWN>UNSUPPORTED>PASS>NOT_APPLICABLE",
            },
        },
...
def main() -> int:
    ...
    if args.check:
        # Downstream artifacts pin this registry, so closure validation is a
        # second pass after all generated dependents have been refreshed.
